...
public class RestaurantOrderActivity extends AppCompatActivity {
    ...
    final String TAG = "RESTAURANTORDERACTIVITY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        placeholderText = findViewById(R.id.restaurantOrderPlaceholder);
        latestOrder = findViewById(R.id.restaurantOrderLatestOrder);
        previousOrders = findViewById(R.id.restaurantOrderPreviousOrders);
